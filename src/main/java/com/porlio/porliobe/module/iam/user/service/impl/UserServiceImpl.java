...
import com.porlio.porliobe.module.iam.user.mapper.UserMapper;
...
public class UserServiceImpl implements UserService {
  ...
  @Transactional
  @Override
  public RegistrationResponse register(UserCreationRequest request) {
    ...
    // Step 7: Map saved user to RegistrationResponse and return
